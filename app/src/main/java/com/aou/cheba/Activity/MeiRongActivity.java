 ...
 */
public class MeiRongActivity extends SwipeBackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.meirong_fragment);
    ...
    private void findviewbyid() {
        rl_wai = (LinearLayout) findViewById(R.id.rl_wai);
        ll_home = (RelativeLayout) findViewById(R.id.ll_xiyou);
        ...
        tv_sousuo.setOnClickListener(new MyOnclikListener());
...
//                            iv_sousuo.setVisibility(View.GONE);
      ...
      /*  if (Build.VERSION.SDK_INT >= 19) {
            ...
            vParams1.height = (int) (DisplayUtil.getMobileHeight(MeiRongActivity.this) * 0.Data_Util.HEAD_HEIGHT);
            ll_home.setLayoutParams(vParams1);
        } else {
            ViewGroup.LayoutParams vParams1 = ll_home.getLayoutParams();
            vParams1.height = (int) (DisplayUtil.getMobileHeight(MeiRongActivity.this) * 0.05);
            ll_home.setLayoutParams(vParams1);
        }*/
    }
    ...
    private void Location() {
        ...
        //注册监听
        int type = MeiRongActivity.this.getIntent().getIntExtra("from", 0);
        if (type == 0) {
...
//                +location.getDistrict()+location.getStreet();
        ...
        mLoadMoreListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (!isenter) {
                    ...
                    Intent intent = new Intent(MeiRongActivity.this, MeiRong_xiangqiang_Activity.class);
                    intent.putExtra("position", position);
                    intent.putExtra("objBean", objBean);
                    startActivity(intent);

                /*    MyCode_meirong.ObjBean objBean = list_meirong.get(position);
                    Intent intent = new Intent(MeiRongActivity.this, HuaTi_Activity.class);
                    intent.putExtra("position", position);
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(MeiRongActivity.this, R.layout.meirong_item, null);
...
//屏幕适配
            ...
            vParams.height = (int) (DisplayUtil.getMobileHeight(MeiRongActivity.this) * 0.11);
            holderRightImg.image_dian.setLayoutParams(vParams);
            Glide.with(MeiRongActivity.this).load(list_meirong.get(position).getPictrue().split(",")[0]).into(holderRightImg.image_dian);
    ...
    private void inithttp_data(long id, final int page, String s) {
        ...
        RequestBody requestBody = RequestBody.create(JSON, "{\"token\":\"" + SPUtils.getString(MeiRongActivity.this, "token") + "\",\"obj\":{\"addr\":\"" + s + "\"},\"page\":{\"id\":" + id + "}}");
//创建一个请求对象
            ...
            public void onFailure(Call call, IOException e) {
                h.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        MyToast.showToast(MeiRongActivity.this, "连接服务器失败");
                    }
                }, 400);
            }
                    ...
                    public void run() {
                        if (mycode.getCode() == 0) {
                            ...
                            if (rows.size() != 0) {
                                ...
                                mLoadMoreListView.onLoadComplete();
                                mLoadMoreListView.setHaveMoreData(false);
                                MyToast.showToast(MeiRongActivity.this, "暂无更多数据");
                            }
                        } else {
                            mRefreshAndLoadMoreView.setRefreshing(false);
                            mLoadMoreListView.onLoadComplete();
    ...
    private void inithttp_search(long id, final int page, String s) {
        ...
        RequestBody requestBody = RequestBody.create(JSON, "{\"token\":\"" + SPUtils.getString(MeiRongActivity.this, "token") + "\",\"obj\":{\"store_name\":\"" + s + "\"},\"page\":{\"id\":" + id + "}}");
//创建一个请求对象
        Request request = new Request.Builder()
            ...
            switch (view.getId()) {
                ...
                case R.id.tv_sousuo:
                    if (TextUtils.isEmpty(et_sousuo.getText().toString().trim())) {
                        MyToast.showToast(MeiRongActivity.this,"请输入搜索内容");
                    } else {
                        issearch = true;
